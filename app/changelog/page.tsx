...
const releases = [
    ...
    },
    {
        ...
        changes: [
            ...
            "Added automatic Skill Effect detection from the real skill data for Burn, Poison, Healing, Stun, Vulnerability, Knockback, Damage Increase, Damage Reduction, Shield, Taunt, and Stagger.",
            ...
            "Added statically generated, shareable profile pages for every monster with artwork, skills, passives, obtainment sources, reference stats, evolution families, calculator links, and profile-copy actions.",
            "Replaced placeholder passive text with readable descriptions generated from existing passive effect data, clarified conditional requirements, distinguished Marigon Fortune Spirit, and removed repetitive effect chips.",
            ...
            "Added a dedicated Monster Database social preview image with route-specific Open Graph, Twitter card, canonical URL, and GitHub Pages metadata.",
        ],
    },
    {
        version: "v1.0.4",
