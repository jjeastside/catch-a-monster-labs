  ...
  return (
    ...
    >
      <span
        className={
          compact
            ? "shrink-0 text-[10px] text-[#a9b7cd]"
            : "mb-1.5 block text-[10px] font-bold uppercase tracking-[0.12em] text-[#7f8b9e]"
        }
      >
        {label}
      </span>
        ...
        {selectedItem ? (
          <>
            <img
              ...
              alt=""
              className={
                compact ? "size-6 shrink-0 rounded object-contain" : "size-7 shrink-0 rounded object-contain"
              }
            />
            <span className="min-w-0 flex-1">
              ...
              <span
                className={`block truncate text-[9px] leading-tight ${rarityTextClasses[selectedItem.rarity]}`}
              >
                +{selectedItem.percentage}%{" "}
                {selectedItem.type === "weapon" ? "Damage" : "Health"}
              </span>
            </span>
          </>
        ) : (
            ...
            return (
              ...
              >
                ...
                <span className="min-w-0 flex-1">
                  ...
                  <span
                    className={`mt-0.5 block text-[10px] ${rarityTextClasses[item.rarity]}`}
                  >
                    {item.rarity} · +{item.percentage}%{" "}
                    {item.type === "weapon" ? "Damage" : "Health"}
                  </span>
                </span>
