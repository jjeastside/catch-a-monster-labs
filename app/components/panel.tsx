...
export function Panel({ eyebrow, title, children, action }: PanelProps) {
    return (
        <section className="flex min-h-[390px] w-full min-w-0 max-w-full flex-col overflow-visible rounded-xl border border-[#3b4759] bg-[#0f1620] shadow-[0_16px_50px_rgba(0,0,0,0.18)] lg:h-full lg:min-h-0 lg:overflow-hidden">
