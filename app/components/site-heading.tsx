export function SiteHeading() {
    return (
        ...
        >
            <div
                aria-hidden="true"
                className="pointer-events-none absolute inset-x-0 bottom-0 h-px bg-gradient-to-r from-transparent via-[#7585ff]/65 to-transparent"
            />
            <div
                aria-hidden="true"
                className="pointer-events-none absolute -left-20 -top-24 size-48 rounded-full bg-[#7585ff]/[0.06] blur-3xl"
            />

            <div className="relative mx-auto w-full max-w-[1800px] px-4 py-2.5 sm:px-5 xl:px-7 2xl:px-8">
                <div className="min-w-0 border-l-2 border-[#7585ff]/75 pl-3">
                    <h1
                        id="calculator-heading"
                        className="text-[17px] font-bold tracking-tight text-[#f2f4f8]"
                    >
