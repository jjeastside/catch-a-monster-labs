...
export const releases: readonly ChangelogRelease[] = [
    {
        ...
        changes: [
            ...
            "Separated Team Goals from Combat Contexts so recommendations can combine Balanced, Highest DPS, Survivability, or Support / Utility with Standard, Boss, Rift, or Dungeon conditions.",
            "Added compact icons to Team Overview for Damage, Health, Average DPS, Survivability, and Synergy, reusing Team Builder stat icons for the first three.",
            "Added Find a Team and Improve My Monsters recommendation modes; inventory improvement suggestions identify owned monsters to upgrade and preview Level, Rank, or Enhancement gains in Skill DPS and Health.",
            "Made improvement recommendations respect the chosen Team Goal and Combat Context, offer Edit in Inventory, and cap level previews at 110.",
